...
graph.addNode("accept_answer",acceptAnswer); // new
graph.addNode("revise_answer",reviseAnswer); // new
graph.addNode("document_not_sufficient",noRelevantDocs); // new
...
graph.addConditionalEdges("is_relevant",relevanceRouting); 
graph.addEdge("generate_from_context", "is_sup"); 
graph.addEdge("no_relevant_docs", END); 
graph.addConditionalEdges("is_sup",supportRouting); // new
graph.addEdge("accept_answer", END); // new
graph.addEdge("revise_answer", "is_sup"); // new
